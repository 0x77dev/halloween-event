...
class EssentiaWorkletProcessor extends AudioWorkletProcessor {
  ...
  process(
    ...
    const result: ProcessingResult = { rms: rmsFrame.rms, energy: energyFrame.energy, loudness: loudnessFrame.loudness }
...
registerProcessor('processor', EssentiaWorkletProcessor);